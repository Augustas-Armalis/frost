...
const PasswordSettings = ({ password = "password idk", ref }) => {
  ...
  return (
    <div className="!mb-2 w-full flex flex-col gap-1.5 flex-grow" ref={ref}>
      <label htmlFor="password" className="text-2xl font-bold max-[402px]:text-xl">
        Password
      </label>

      <div className="flex gap-2 justify-between">
        <input type={isPasswordVisible ? "text" : "password"} id="password" className="mt-2 w-full p-2 !pl-4 bg-white/10 border border-white/20 rounded-[10px] flex items-center !pt-2 !pb-2 overflow-hidden relative shadow-[inset_0px_0px_10.8px_0px_rgba(255,255,255,0.25)] custom-input backdrop-blur-[10px] font-medium text-xl max-[402px]:text-lg" placeholder="Password" value={passwordValue} onChange={handleChange} disabled={!isEditing || isSaved} minLength={6} required />
