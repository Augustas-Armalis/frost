...
// import Email from "../back-end-things/Email.jsx"
  ...
  return (
    <>
      <div className="!mb-2 w-full flex flex-col gap-1.5 flex-grow" ref={ref} >
        <label htmlFor="Email" className="text-2xl font-bold max-[402px]:text-xl">Email</label>

        <div className="flex gap-2 justify-between">
        <input type="email" id="email" className="mt-2 w-full p-2 !pl-4 bg-white/10 border border-white/20 rounded-[10px] flex items-center !pt-2 !pb-2 overflow-hidden relative shadow-[inset_0px_0px_10.8px_0px_rgba(255,255,255,0.25)] backdrop-blur-[10px] font-medium text-xl max-[402px]:text-lg" placeholder="Email" value={name} onChange={handleChange} disabled={!isEditing || isSaved} required />
