...
const ReferralLinkBox = ({ ref }) => {
  ...
  return (
    ...
    <div ref={ref} className="glass-box w-[563px] relative !gap-3 flex flex-col !p-5 max-[1078px]:w-full min-w-[370px] max-[402px]:min-w-full max-[402px]:!p-4 max-[402px]:!pt-3 max-[402px]:!pr-[16px] opacity-0 overflow-hidden justify-between max-[1464px]:w-full">
