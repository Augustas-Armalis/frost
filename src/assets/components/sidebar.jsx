...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar glass-box fixed flex flex-col justify-between left-6 top-[108px] bottom-6 w-[250px] !p-[24px] z-999999">

      <div className="flex flex-col w-full gap-2">
        <SidebarActiveBtn path="/homepage" icon="src/assets/images/icons/dashboard.png" label="Dashboard"/>
