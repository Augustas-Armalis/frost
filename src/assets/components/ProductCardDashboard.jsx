...
const ProductCardDashboard = () => {
  return (
    <div className="w-[226px] h-fit !pb-12 bg-[#436AAE] relative overflow-hidden rounded-2xl border border-white/20 max-[828px]:w-[300px] max-[692px]:w-[220px] max-[538px]:w-[300px]">
