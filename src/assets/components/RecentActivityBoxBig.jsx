...
const RecentActivityBoxBig = ({ref}) => {
  return (
    <div ref={ref} className=" glass-box w-full !h-full min-h-[100vh] !p-6 !pr-3 !pt-5 max-[1078px]:w-full min-w-[370px] max-[402px]:min-w-full max-[402px]:!p-4 max-[402px]:!pt-3 max-[402px]:!pr-[8px] opacity-0">

      <div className="activity-container !mt-2 overflow-y-scroll overflow-x-hidden scrollbar-hidden h-full flex flex-col gap-6 !pb-4 [mask-image:linear-gradient(to_bottom,rgba(0,0,0,1)_calc(100%-50px),rgba(0,0,0,0)_100%)]">
...
export default RecentActivityBoxBig;