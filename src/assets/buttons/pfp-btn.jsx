const PfpBtn = ({ icon, label, path }) => {
  return (
    <a href={path} className="sidebar-btn flex items-center gap-3 w-full !pl-3 !pt-2 !pb-2 !pr-4 cursor-pointer transition-all duration-100 ease-linear hover:bg-white/10">
